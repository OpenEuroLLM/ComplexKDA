...
def chunk_kda_bwd(
    ...
    **kwargs,
    ...
    wy_backward = chunk_kda_bwd_wy_dqkg_fused if wy_backward is None else wy_backward
    dq, dk, dv, db, dg, dAkk = wy_backward(
        q=q,
        k=k,
        v=v,
        v_new=v_new,
    ...
    norm_gauge_kwargs = {} if q_rstd is None else dict(parity=parity, q_rstd=q_rstd, k_rstd=k_rstd)
    intra_backward = chunk_kda_bwd_intra if intra_backward is None else intra_backward
    dq, dk, db, dg = intra_backward(
        q=q,
        k=k,
        g=g,
        beta=beta,
