...
kda_registry.register(KDATritonBackend())
kda_registry.register(KDABaselineTileLangBackend())
kda_registry.register(KDAOptimizedTritonBackend())
kda_registry.register(KDAOptimizedHybridBackend())
